...
>
  ...
  <xsl:key name="stringLengths" match="COLUMN[./DATA_TYPE = 'VARCHAR2' or ./DATA_TYPE = 'VARCHAR' or ./DATA_TYPE = 'NVARCHAR2' or ./DATA_TYPE = 'NVARCHAR' or ./DATA_TYPE = 'VARBINARY']" use="CHARACTER_MAXIMUM_LENGTH"/>
...
-->
      ...
      <xsl:for-each select="//COLUMN[./DATA_TYPE = 'VARCHAR2' or ./DATA_TYPE = 'VARCHAR' or ./DATA_TYPE = 'NVARCHAR2' or ./DATA_TYPE = 'NVARCHAR' or ./DATA_TYPE = 'VARBINARY'][generate-id() = generate-id(key('stringLengths',CHARACTER_MAXIMUM_LENGTH)[1])]">
  ...
  <xsl:template match="DATA_TYPE[. = 'DOUBLE']">
  ...
  <xsl:template match="DATA_TYPE[. = 'BIT']">
    <xsl:text>cobos:bitField</xsl:text>
  </xsl:template>
  ...
  <xsl:template match="DATA_TYPE[. = 'CHAR' or . = 'NCHAR']">
    <xsl:text>cobos:char</xsl:text>
  </xsl:template>

  <xsl:template match="DATA_TYPE[. = 'VARCHAR' or . = 'VARCHAR2' or . = 'NVARCHAR' or . = 'NVARCHAR2' or . = 'VARBINARY']">
  ...
  <xsl:template match="DATA_TYPE[. = 'BLOB' or . = 'TINYBLOB' or . = 'MEDIUMBLOB' or . = 'LONGBLOB']">
