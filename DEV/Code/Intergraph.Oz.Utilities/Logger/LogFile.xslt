...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl"
                xmlns:cad="http://www.intergraph.com/oz/cad/utilities/logger"
>
        ...
        <form id="main" action="">
          ...
          <p class="metadata">
            <table class="metadata" cellpadding="0px" cellspacing="1px">
              <xsl:apply-templates select="/cad:LogFile/cad:Metadata" mode="createMetadataTable" />
            </table>
          </p>
  ...
  <xsl:template match="cad:Information">
  ...
  <xsl:template match="cad:Warning">
    <tr class="warning">
      <td class="messageType">
        Warning
      </td>
  ...
  <xsl:template match ="cad:Metadata">
  </xsl:template>

  <!-- create metadata table seperately from the logging table -->
  <xsl:template match ="cad:Metadata" mode="createMetadataTable">
    <tr>
      <td class="name">
        <xsl:value-of select="./cad:Name/text()"/>:
      </td>
      <td class="value">
        <xsl:value-of select="./cad:Value/text()"/>
      </td>
    </tr>
  </xsl:template>
