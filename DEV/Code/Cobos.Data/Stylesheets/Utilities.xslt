...
>
	...
	<xsl:template name="nsdecl">
		<xsl:variable name="nsdecl">
			<nsdecl xmlns:cobos="http://schemas.cobos.co.uk/datamodel" 
...
This schema was auto-generated by Cobos.Data tools.
-->
]]></xsl:text>
	</xsl:template>
...
//------------------------------------------------------------------------------
//
// This source code was auto-generated by Cobos.Data tools.
//
]]></xsl:text>
	</xsl:template>
