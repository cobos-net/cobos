...
>
	...
	<xsl:variable name="newlineTab5" select="concat( $newline, $tab, $tab, $tab, $tab, $tab )"/>
	<xsl:variable name="newlineTab6" select="concat( $newline, $tab, $tab, $tab, $tab, $tab, $tab )"/>
	<xsl:variable name="newlineTab7" select="concat( $newline, $tab, $tab, $tab, $tab, $tab, $tab, $tab )"/>
	<xsl:variable name="newlineTab8" select="concat( $newline, $tab, $tab, $tab, $tab, $tab, $tab, $tab, $tab )"/>
