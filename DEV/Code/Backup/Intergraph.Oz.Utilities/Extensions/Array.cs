...
namespace Intergraph.Oz.Utilities.Extensions
{
	...
	{
		/// <summary>
		/// Appends the contents of a2 into a1.  Modifies a1 directly.
		/// </summary>
		...
		public static T[] Append<T>( this T[] a1, T[] a2 )
		{
			...
			{
				a1 = new T[ a2.Length ];
				System.Array.Copy( a2, a1, a2.Length );
			}
			else
			{
				IEnumerable<T> concat = a1.Concat( a2 );
				a1 = concat.Cast<T>().ToArray();
			}
		...
		/// <summary>
		/// Appends the object obj into a1.  Modifies a1 directly.
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="a1"></param>
		/// <param name="a2"></param>
		...
		public static T[] Append<T>( this T[] a1, T obj )
		{
			...
			{
				IEnumerable<T> concat = a1.Concat( new T[] { obj } );
				a1 = concat.Cast<T>().ToArray();
			}
		...
		/// <summary>
		/// Concatenates a1 and a2 into a new array and returns the result.
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="a1"></param>
		/// <param name="a2"></param>
		/// <returns>Returns the new array resulting from the concatenation.</returns>
		public static T[] Concat<T>( this T[] a1, T[] a2 )
		{
			if ( a1 == null || a2 == null )
			{
				...
				if ( a1 == null )
				{
					T[] ac = new T[ a2.Length ];
					System.Array.Copy( a2, ac, a2.Length );
					return ac;
				}
				else
				{
					T[] ac = new T[ a1.Length ];
					System.Array.Copy( a1, ac, a1.Length );
					return ac;
				}
			}
			...
			return concat.Cast<T>().ToArray();
		}

		/// <summary>
		/// Concatenates a1 and object obj into a new array and returns the result.
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="a1"></param>
		/// <param name="a2"></param>
		/// <returns>Returns the new array resulting from the concatenation.</returns>
		public static T[] Concat<T>( this T[] a1, T obj )
		{
				if ( a1 == null )
				{
					return new T[] { obj };
