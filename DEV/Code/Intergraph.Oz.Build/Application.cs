...
namespace Intergraph.Oz.Build
{
	public static class Application
	{
		...
		public static void AddRCFile( RCFile rcFile )
		{
			...
			{
				_manifest.rcFiles.rcFile = _manifest.rcFiles.rcFile.Append( rcFile );
			}
		}
		...
		public static void AddSolutionFile( SolutionFile slnFile )
		{
			...
			{
				_manifest.solutionFiles.solutionFile = _manifest.solutionFiles.solutionFile.Append( slnFile );
			}
		}
		...
		private static void BuildSolutions()
		{
			...
			Array.Sort( _manifest.solutionFiles.solutionFile, new SolutionFile.Comparer() );
