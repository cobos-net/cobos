...
-->
  ...
  <xsl:template match="DATA_TYPE[. = 'TINYINT']">
    <xsl:text>xsd:unsignedByte</xsl:text>
  </xsl:template>
  ...
  <xsl:template match="DATA_TYPE[. = 'NUMBER' and ../NUMERIC_PRECISION &lt;= 3]">
    <xsl:text>xsd:unsignedByte</xsl:text>
  </xsl:template>

  <xsl:template match="DATA_TYPE[. = 'NUMBER' and ../NUMERIC_PRECISION = 5]">
    <xsl:text>xsd:short</xsl:text>
  </xsl:template>

  <xsl:template match="DATA_TYPE[. = 'NUMBER' and ../NUMERIC_PRECISION = 10]">
    <xsl:text>xsd:int</xsl:text>
  </xsl:template>

  <xsl:template match="DATA_TYPE[. = 'NUMBER' and ../NUMERIC_PRECISION = 19]">
    <xsl:text>xsd:long</xsl:text>
  </xsl:template>
